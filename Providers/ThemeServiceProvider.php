...
class ThemeServiceProvider extends ServiceProvider
{
    ...
    {
        if ($this->app->runningInConsole() || ! app('encore.isInstalled')) {
            return;
        }

        if ($this->inAdministration()) {
            $themeName = $this->app['config']->get('encore.core.core.admin-theme');
    ...
    private function inAdministration()
    {
        ...
        return $this->app['request']->segment($segment) === $this->app['config']->get('encore.core.core.admin-prefix');
    }
